function EEG_flexion_epochs_Time_Domain_channels(data, std_sem, P1, P3, P6, flx_ext, ch_sr)
    ...
    tiledlayout(8,8)
    sgtitle(sprintf(['Time-Domain (', flx_ext,', Mean $\\pm$ %s): %d epochs P1, %d epochs P3, %d epochs P6'], ...
