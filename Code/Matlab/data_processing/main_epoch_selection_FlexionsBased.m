function Epochs_Flexion_based = ...
    main_epoch_selection_FlexionsBased(input_streams, ...
                                       EEG, ...
                                       Trials_Info, ...
                                       EMG_sensor_id, ...
                                       subject_id, ...
    ...
    Final_Trial_based_Structure = ...
        struct('EEG_stream', EEG_stream, ...
               'EMG_stream', EMG_Structure, ...
               'EXP_stream', EXP_structure);
    
    Epochs_Flexion_based = repmat({Final_Trial_based_Structure}, ...
