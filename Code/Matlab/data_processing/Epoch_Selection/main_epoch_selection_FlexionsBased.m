function main_epoch_selection_FlexionsBased(input_streams, ...
    ...
    for i = 1:length(Trials_Info)
        Epochs_Flexion_based{1, i}.General = Trials_Info{1, i}.General;
        Epochs_Flexion_based{1, i}.General.Muscles_Names = Muscles_names;
    end
    ...
    for i = 1:length(Trials_Info)
        ...
        if ~endsWith(Trials_Info{1, i}.General.Description, 'Data Loss')
            ...
            raw_end_indices = Trials_Info{1, i}.Events.EEG_stream.Raw.flexion_end_indx;
            pre_start_indices = Trials_Info{1, i}.Events.EEG_stream.Preprocessed.flexion_start_indx;
            pre_end_indices = Trials_Info{1, i}.Events.EEG_stream.Preprocessed.flexion_end_indx;
        
            % Preallocate the EEG_stream structure
            Epochs_Flexion_based{1, i}.EEG_stream.Raw = struct();
            Epochs_Flexion_based{1, i}.EEG_stream.Preprocessed = struct();
        
            % Use arrayfun to fill in Raw Time Domain data
            Epochs_Flexion_based{1, i}.EEG_stream.Raw.Times = ...
                arrayfun(@(s, e) All_EEG_time(s:e), ...
                raw_start_indices, raw_end_indices, 'UniformOutput', false);
        
            Epochs_Flexion_based{1, i}.EEG_stream.Raw.Channels = ...
                arrayfun(@(s, e) extract_epoch_data(All_EEG, s, e), ...
                raw_start_indices, raw_end_indices, 'UniformOutput', false);
        
            % Use arrayfun to fill in Preprocessed Time Domain data
            Epochs_Flexion_based{1, i}.EEG_stream.Preprocessed.Times = ...
                arrayfun(@(s, e) EEG.times(s:e), ...
                pre_start_indices, pre_end_indices, 'UniformOutput', false);
        
            Epochs_Flexion_based{1, i}.EEG_stream.Preprocessed.Channels = ...
                arrayfun(@(s, e) extract_epoch_data(channel_data, s, e), ...
                pre_start_indices, pre_end_indices, 'UniformOutput', false);
        
            Epochs_Flexion_based{1, i}.EEG_stream.Preprocessed.Sources = ...
            ...
            %% EXP_stream
            % Define indices
            start_indices = Trials_Info{1, i}.Events.EXP_stream.flexion_start_indx;
            end_indices = Trials_Info{1, i}.Events.EXP_stream.flexion_end_indx;
        
            % Preallocate the EXP_stream structure
            Epochs_Flexion_based{1, i}.EXP_stream = struct();
        
            % Use arrayfun to fill in Times, Forces, Encoder_angle, and Ref_angle
            Epochs_Flexion_based{1, i}.EXP_stream.Times = ...
                arrayfun(@(s, e) All_Experiment_time(s:e), ...
                start_indices, end_indices, 'UniformOutput', false);
        
            Epochs_Flexion_based{1, i}.EXP_stream.Forces = ...
                arrayfun(@(s, e) All_Experiment(5, s:e), ...
                start_indices, end_indices, 'UniformOutput', false);
        
            Epochs_Flexion_based{1, i}.EXP_stream.Encoder_angle = ...
                arrayfun(@(s, e) All_Experiment(1, s:e), ...
                start_indices, end_indices, 'UniformOutput', false);
        
            Epochs_Flexion_based{1, i}.EXP_stream.Ref_angle = ...
                arrayfun(@(s, e) ...
            ...
            %% EMG_stream
            % Define indices
            start_indices = Trials_Info{1, i}.Events.EMG_stream.flexion_start_indx;
            end_indices = Trials_Info{1, i}.Events.EMG_stream.flexion_end_indx;
        
            % Preallocate the EMG_stream structure
            Epochs_Flexion_based{1, i}.EMG_stream = struct();
        
            % Use arrayfun to populate Times, Sensors_Raw, and Sensors_Preprocessed
            Epochs_Flexion_based{1, i}.EMG_stream.Times = ...
                arrayfun(@(s, e) All_EMG_time(s:e), ...
                start_indices, end_indices, 'UniformOutput', false);
        
            Epochs_Flexion_based{1, i}.EMG_stream.Sensors_Raw = ...
                arrayfun(@(s, e) All_EMG(EMG_sensor_id, s:e), ...
                start_indices, end_indices, 'UniformOutput', false);
        
            Epochs_Flexion_based{1, i}.EMG_stream.Sensors_Preprocessed = ...
