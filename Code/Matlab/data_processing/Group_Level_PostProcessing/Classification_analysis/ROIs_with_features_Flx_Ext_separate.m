function ROIs = ROIs_with_features_Flx_Ext_separate(all_STUDY_names, all_STUDY_files, subject_list, ...
    epoch_type, features_from_epochs, data_path, per_trial_or_all_epochs, pressure_score)
    ...
    for i = 1:length(subject_list)
        ...
        [data, frequencies] = calculate_PSD_Flx_Ext_separate(data, Trials_Info, subject_list(i));
            ...
            if ~isempty(subject_comps)
                ...
                for k = 1:length(subject_sets_indx)
                    ...
                    [ROIs.(all_STUDY_names{1, j})(subject_sets_indx(k), 3), ...
                        ...
                        RMS_features_generator_Flx_Ext_separate(condition_indices, data, IC, frequencies, per_trial_or_all_epochs, pressure_score);
                end
    ...
    extension = ['_', per_trial_or_all_epochs, '_', pressure_score, '_Based','_Flx_Ext_separate.mat']; 
