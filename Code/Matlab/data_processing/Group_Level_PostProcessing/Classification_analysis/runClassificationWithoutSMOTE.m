function [bestModel, meanAccuracy, stdAccuracy, acc_full, acc_selected, featureTable] = ...
    runClassificationWithoutSMOTE(X, Y, subject, folder_path)
    
    % runClassificationWithoutSMOTE function
    % Implements:
    ...
    for rep = 1:numRepeats
        ...
        for fold = 1:cv.NumTestSets
            ...
            opts = struct('CVPartition', cvpartition(Y_train, 'KFold', 5), ...
            ...
            mdl_full = fitcauto(X_train, Y_train, ...
            ...
            if ~isempty(selectedIdx)
                mdl_selected = fitcauto(X_train_selected, Y_train, ...
                                        'Learners', learnerTypes, ...
                                        'OptimizeHyperparameters', 'auto', ...
                                        'HyperparameterOptimizationOptions', opts);
