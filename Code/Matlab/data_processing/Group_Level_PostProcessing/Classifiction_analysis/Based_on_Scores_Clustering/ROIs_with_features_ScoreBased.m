function ROIs = ROIs_with_features_ScoreBased(all_STUDY_names, all_STUDY_files, subject_list, ...
    ...
    for i = 1:length(subject_list)
        ...
        % Find all conditions indices in trials based on Scores Clustering
        % S1, S2, and S3
    ...
    extension = ['_', per_trial_or_all_epochs, '_ScoreBased','.mat']; 
